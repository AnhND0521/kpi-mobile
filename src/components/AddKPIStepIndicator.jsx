  ...
  return (
    ...
    <div className='relative w-3/5 h-20 flex-col items-center gap-4 self-center'>
      <div className='flex items-center justify-between'>
        ...
        <div className={step == 1 ? 'flex justify-center w-8 h-8 bg-purple rounded-full' : 'flex justify-center w-4 h-4 bg-purple rounded-full'}>
        ...
        <div className={step == 2 ? 'flex justify-center w-8 h-8 bg-purple rounded-full' : 'flex justify-center w-4 h-4 bg-darkGray rounded-full'}>
